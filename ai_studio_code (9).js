...
(function() {
    ...
    const Config = {
        API_URL: `https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent?key=AIzaSyBnPDaJJwoqjgFEybiaRNOamLG4dsVtejk`, // IMPORTANT: Add your Gemini Key from ```AIzaSyBV3tdBWu8sCl0V7bDEy1ODRKcvA1nqUls```

...
(function() {
    ...
    const Config = {
        API_URL: `https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key=AIzaSyBV3tdBWu8sCl0V7bDEy1ODRKcvA1nqUls`, // IMPORTANT: Add your Gemini Key from ```AIzaSyBV3tdBWu8sCl0V7bDEy1ODRKcvA1nqUls```
